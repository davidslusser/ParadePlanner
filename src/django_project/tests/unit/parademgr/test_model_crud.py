    ...
    def test_update_award_type(self):
        ...
        if original_value:
            updated_value = random.choice(
                self.model.award_type.field.related_model.objects.exclude(pk=original_value.pk)
            )
        else:
...
class ParticipantTests(TestCase):
    ...
    def test_update_organization(self):
        ...
        if original_value:
            updated_value = random.choice(
                self.model.organization.field.related_model.objects.exclude(pk=original_value.pk)
            )
        else:
