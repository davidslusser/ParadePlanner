...
def create_parade_participants(qty: int = 1) -> None:
    ...
    for i in range(qty):
        ...
        Participant.objects.get_or_create(parade=parade, organization=organization, division=division, defaults=data)
    ...
    data_list: list = [
        ...
        # Bands
        {
            ...
            "data": [
                {
                    "name": "1st Place",
                    "description": "Ann Anderson Grand Sweepstakes",
                    "award_type": "cash",
                    "amount": "1000.00",
                },
