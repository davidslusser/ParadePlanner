...
# import models
from parademgr.models import (Organization,
                              Contact,
                              Address,
                              PhoneNumber,
                              EmailAddress,
...
class AddressAdmin(admin.ModelAdmin):
    list_display = ['id', 'created_at', 'updated_at', 'street_address', 'address_extra', 'city', 'state', 'postal_code', 'address_type']
...
class ParticipantAdmin(admin.ModelAdmin):
    list_display = ['id', 'created_at', 'updated_at', 'parade', 'organization', 'division', 'entry', 'street', 'march_order']
