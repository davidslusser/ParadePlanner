...
class AddressFilterSet(FilterSet):
    ...
    organization = RelatedFilter(
        "OrganizationFilterSet", field_name="organization", queryset=Organization.objects.all()
    )
...
class AwardFilterSet(FilterSet):
    ...
    participantaward = RelatedFilter(
        "ParticipantAwardFilterSet", field_name="participantaward", queryset=ParticipantAward.objects.all()
    )
...
class ContactFilterSet(FilterSet):
    ...
    phone_numbers = RelatedFilter(
        "PhoneNumberFilterSet", field_name="phone_numbers", queryset=PhoneNumber.objects.all()
    )
